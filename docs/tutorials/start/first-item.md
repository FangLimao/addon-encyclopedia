...
- 1.10，最早期的格式版本，只含有最基础的组件，但无需开启实验性玩法
- 1.16.100，加入了许多新的物品组件，在很长一段时间内是自定义物品的最佳选择，但需要开启假日创作者实验性玩法，**在最新版本无法使用**；
- 1.20.0+，物品组件趋于稳定的格式版本，兼有1.16.100格式版本的功能与1.10格式版本的无需开启实验性玩法。

因此，我们建议使用1.20.0+格式版本，这里我们选用`1.20.30`。
